...
// Odejmowanie dodatnich A i B, A > B dla ogromnego wejscia
TEST(Subtract, HugePositiveNumbers_AGreaterThanB){

    SignedMagnitude a({0x1A, 0x4B, 0x6E, 0x35, 0x78, 0x92, 0x0F, 0x2C, 0x5D, 0x7A, 0x8B, 0x33, 0x46, 0x9F, 0x51, 0x79, 0x6A, 0x2E, 0x0D, 0x5C,
                       0x61, 0x88, 0x2A, 0x3C, 0x75, 0x9E, 0x47, 0x1B, 0x50, 0x9D, 0x2F, 0x36, 0x8C, 0x72, 0x4D, 0x4A, 0x93, 0x3E, 0x87, 0x1F,
                       0x56, 0x69, 0x0C, 0x5B, 0x8A, 0x41, 0x9B, 0x67, 0x4E, 0x30, 0x81, 0x98, 0x64, 0x43, 0x7C, 0x55, 0x39, 0x26, 0x59, 0x96}, 0, false);
    SignedMagnitude b({0x3E, 0x87, 0x1F, 0x1b, 0x50,  0x6A, 0x2E, 0x0D, 0x5C, 0x74, 0x54, 0xb6, 0xde, 0x02, 0x84, 0xdf, 0xff, 0xc2,0x3b, 0x06}, 0, false);

    ASSERT_EQ((a-b).toString(), "0x1a4b6e3578920f2c5d7a8b33469f51796a2e0d5c61882a3c759e471b509d2f368c724d4a933e871f17e1ed4039d76d59f1bc2ce18640f77539641e90");
...
// ========================================================================================================================================
//mnozenie, przy czym liczby sa duze
TEST(Multiply, HugePositiveNumbers){

    SignedMagnitude a({0x1A, 0x4B, 0x6E, 0x35, 0x78, 0x92, 0x0F, 0x2C, 0x5D, 0x7A,0x8B, 0x33, 0x46, 0x9F, 0x51, 0x79, 0x6A, 0x2E, 0x0D, 0x5C}, 0, false);
    SignedMagnitude b({0x27, 0x8E, 0x43, 0x52, 0x9F, 0x16, 0x74, 0x3D, 0x65, 0x4B, 0x88, 0x36, 0x59, 0x7C, 0x21, 0x6A, 0x0E, 0x93, 0x2F, 0x5D}, 0, false);

    ASSERT_EQ((a*b).toString(), "0x04101a8b815f94e2306713c6d951e4002eeca985e2949f5a45cab6cab856c4d9afb6c4debb02be6c");
...
//test dla duzych liczb
TEST(Divide, HugeNumbers){
    SignedMagnitude a({0x1A, 0x4B, 0x6E, 0x35, 0x78, 0x92, 0x0F, 0x2C, 0x5D, 0x7A, 0x8B, 0x33, 0x46, 0x9F, 0x51, 0x79, 0x6A, 0x2E, 0x0D, 0x5C,
                       0x61, 0x88, 0x2A, 0x3C, 0x75, 0x9E, 0x47, 0x1B, 0x50, 0x9D, 0x2F, 0x36, 0x8C, 0x72, 0x4D, 0x4A, 0x93, 0x3E, 0x87, 0x1F,
                       0x56, 0x69, 0x0C, 0x5B, 0x8A, 0x41, 0x9B, 0x67, 0x4E, 0x30, 0x81, 0x98, 0x64, 0x43, 0x7C, 0x55, 0x39, 0x26, 0x59, 0x96}

    , 0, false);
    SignedMagnitude b({0x02}
            , 0, false);
    ASSERT_EQ((a/b).toString(), "0x0d25b71abc4907962ebd4599a34fa8bcb51706ae30c4151e3acf238da84e979b463926a5499f438fab34862dc520cdb3a71840cc3221be2a9c932ccb");
